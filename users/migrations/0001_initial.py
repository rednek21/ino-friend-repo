# Generated by Django 4.2.1 on 2023-08-29 09:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_ru', models.CharField(max_length=32, null=True, unique=True, verbose_name='title')),
                ('title_en', models.CharField(max_length=32, null=True, unique=True, verbose_name='title')),
            ],
            options={
                'verbose_name': 'hobby',
        ...
        migrations.AddField(
            model_name='user',
            name='hobby',
            field=models.ManyToManyField(blank=True, null=True, to='users.hobby'),
        ),
        migrations.AddField(
            model_name='user',
            name='hobby_en',
        ...
        migrations.AddField(
            model_name='user',
            name='residence_city',
            field=models.ForeignKey(blank=True, max_length=128, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.CITIES_CITY_MODEL, verbose_name='residence_city'),
        ),
        migrations.AddField(
            model_name='user',
            name='native_country',
